...
while (True):
    ...
    planet1.force = gforce(planet1, star) + gforce(planet1, planet2) + gforce(
        planet1, planet3) + gforce(planet1, planet4) + gforce(planet1, planet5)
    planet2.force = gforce(planet2, star) + gforce(planet2, planet1) + gforce(
        planet2, planet3) + gforce(planet2, planet4) + gforce(planet2, planet5)
    planet3.force = gforce(planet3, star) + gforce(planet3, planet1) + gforce(
        planet3, planet2) + gforce(planet3, planet4) + gforce(planet3, planet5)
    planet4.force = gforce(planet4, star) + gforce(planet4, planet1) + gforce(
        planet4, planet2) + gforce(planet4, planet3) + gforce(planet4, planet5)
    planet5.force = gforce(planet5, star) + gforce(planet5, planet1) + gforce(
        planet5, planet2) + gforce(planet5, planet3) + gforce(planet5, planet4)
